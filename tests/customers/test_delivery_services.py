...
def test_create_delivery_info_valid() -> None:
    ...
    info = DeliveryInfo(address="Calle Falsa 123", phone="987654321")
...
def test_delivery_info_invalid_phone(bad_phone: str) -> None:
    ...
    with pytest.raises(ValidationError):
        DeliveryInfo(address="Calle Valida 123", phone=bad_phone)
...
def test_delivery_info_invalid_address(bad_address: str) -> None:
    ...
    with pytest.raises(ValidationError):
        DeliveryInfo(address=bad_address, phone="999888777")
